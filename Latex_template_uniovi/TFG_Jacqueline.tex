...
\addcontentsline{toc}{section}{\textsc{Índice general}}
\tableofcontents
\cleardoublepage
\addcontentsline{toc}{section}{\textsc{Índice de figuras}}
\listoffigures
\cleardoublepage
\addcontentsline{toc}{section}{\textsc{Índice de Tablas}}
\listoftables
...
\input{secciones/kapitel1.tex}
\input{secciones/kapitel2.tex}
\input{secciones/kapitel3.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\chapter{\textbf{Conclusiones generales}}
%\thispagestyle{fancy} %para que incluya las cabeceras y los pies de págnina en la primera página del capítulo (por defecto no lo pone)
%\label{capitulo:conclusiones}
%\input{secciones/Conclusiones/conclusiones_generales.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{secciones/abkuerzungen.tex}
\end{document}