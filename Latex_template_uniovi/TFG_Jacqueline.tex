...
\addcontentsline{toc}{chapter}{\textsc{Abbreviations}}
...
\appendix
 %\thispagestyle{fancy}
\chapter{Estimate of costs}	
\begin{table}
\centering 
\includepdf[pages={1,{},2}]{presupuesto}
\caption{\label{tab:costs}Estimate of costs}
\end{table}

\chapter{Gantt Chart}	
 \begin{table}
 \centering
\includepdf[pages={1,{},2}]{gantt}
